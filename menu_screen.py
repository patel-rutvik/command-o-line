...
def menuScreen(state):
    ...
    displayText("COMMAND-O-LINE", 'Antonio-Bold.ttf', 200, display_width / 2, (display_height / 5),
                 white, 0)
    play_state = button("Play game", 'Antonio-Regular.ttf', button_size, white, green, 
                        hovergreen, display_width / 5, display_height - button_size, 50, "play")
    tutorial_state = button("Tutorial", 'Antonio-Regular.ttf', button_size, white, blue,
                             hoverblue, display_width / 2, display_height - button_size, 50, 
                             "tutorial")
    quit_state = button("Quit game", 'Antonio-Regular.ttf', button_size, white, red, hoverred,
